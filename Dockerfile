...
# docker build -t curatela_legal_rails .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name curatela_legal_rails curatela_legal_rails
